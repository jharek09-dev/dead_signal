...
| **Expansion v2 (Narrative Depth)** | 🚧 M-EXP stage 3 started | P1 | Canon ✅; doc propagation ✅; content/code **in progress** (M-EXP, §11) — Echoes + all five region sub-stories + U1 + S1 truth-by-assembly + the prologue second act built (Phase 3 59 nodes, ≈2×); loc+a11y logging / regression bar next |
